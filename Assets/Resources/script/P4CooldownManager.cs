...
public class P4CooldownManager : MonoBehaviour {
    ...
    void Start()
    {
        didPlayerSprint = GameObject.Find("chipmunk team D").GetComponent<PlayerBehavior>().isSprinting;
        didPlayerKick = GameObject.Find("chipmunk team D").GetComponent<PlayerBehavior>().isKicking;
        kickCooldownTime = GameObject.Find("chipmunk team D").GetComponent<PlayerBehavior>().kickCoolDownTime;
        sprintCooldownTime = GameObject.Find("chipmunk team D").GetComponent<PlayerBehavior>().sprintCoolDownTime;
    }
